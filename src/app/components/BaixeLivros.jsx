      ...
      whileInView={{ opacity: 1, scale: 1 }}
        ...
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          ...
          <motion.div className="grid grid-cols-2 gap-4 mt-8"
            initial={{ opacity: 0, scale: 0.5 }}
            whileInView={{ opacity: 1, scale: 1 }}>
            <img className="md:w-full" src="images/estudantecover.png" alt="office content 1" />
            <img className="mt-4 w-full lg:mt-10 " src="images/educadorcover.png" alt="office content 2" />
          </motion.div>
        </div>
      </motion.div>
    </>
