        ...
        <Accordion variant='bordered'>
            ...
            <AccordionItem key="2" aria-label="Accordion 2" title="Realizando o diagnóstico">
              ...
              Para realizar este diagnóstico, você poderá elaborar uma sondagem por meio do Formulários Google e enviá-la
                ...
                sempre que necessário ao longo do projeto. Você pode copiar um modelo base clicando <a href="https://docs.google.com/forms/d/17MEmy1xoCjyanVlCG6ybabrUKZZxyVFkMod538-UyNA/copy" target="_blank" rel="noopener noreferrer" className="underline text-blue-700 hover:text-purple-900"> aqui</a>.
