        ...
        <div className="w-full md:w-2/3">
          <h2 className="text-2xl font-bold mb-4 text-slate-700">Site Por Quê?</h2>
            <p>
              ...
              <a
                href="https://porque.com.br/categoria/graficos/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-800 hover:text-purple-800 underline"
              >
              ...
              , artigos de{' '}
              <a
                href="https://porque.com.br/categoria/blog/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-800 hover:text-purple-800 underline"
              >
              ...
              ,{' '}
              <a
                href="https://porque.com.br/videos/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-800 hover:text-purple-800 underline"
              >
              ...
              sobre temas de economia e atualidades, e também a{' '}
              <a
                href="https://porque.com.br/categoria/econopedia"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-800 hover:text-purple-800 underline"
              >
              ...
              , uma enciclopédia virtual de termos essenciais da Economia.
            </p>
      ...
      <div className="flex mt-8 flex-col md:flex-row">
        <div className="w-full md:w-2/3 pr-4">
          ...
          <p>
            ...
            <a href="https://docs.google.com/forms/d/1ydG9bg9FuV5sAE9tBU9gE1XUMFtHoowFXzrgZeLE2t0/copy" target="_blank" rel="noopener noreferrer" className="text-blue-800 hover:text-purple-800 underline">
              aqui
            </a>
